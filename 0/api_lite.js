function OneCaptchaInit(){var e;document.getElementById("one-captcha").innerHTML=`
    ...
    </style><div id="captcha-container"><div id="verify-section"><input type="checkbox" id="verify-checkbox"><label for="verify-checkbox" class="custom-checkbox"></label><div id="loading-spinner"></div><svg id="check-mark" style="display:none" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#4CAF50"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg><label for="verify-checkbox" id="captcha-label">I'm not a robot.</label><span id="success-message" style="display:none">Success</span></div><div id="brand"><a href="https://github.com/Dev-Huang1/One-Captcha"><img src="https://onecaptcha.us.kg/assets/logo/logo.svg" alt="One Captcha Logo"></a>One Captcha<div class="privacy-terms-links"><a href="https://www.xyehr.cn/one-captcha-privacy-policy" id="privacy-link">Privacy</a><p>·</p><a href="https://docs.xyehr.cn" id="docs-link">Docs</a></div></div></div><div id="slider-captcha"><div id="slider-captcha-header"><span id="slider-captcha-header-text" style="font-weight:700;display:inline-block">Please complete CAPTCHA</span><br><span id="slider-captcha-header-text2" style="font-size:10px">If an error occurs, click the Retry button</span></div><div id="puzzle-container"><img id="puzzle-image" src="" alt="img"><div id="puzzle-piece"></div></div><p id="error-message" style="color:red;display:none">Verification failed. Please try again.</p><div id="slider"><div id="slider-track"></div><div id="slider-handle">→</div></div><div id="slider-captcha-footer"><div id="powered-by"><img src="https://onecaptcha.us.kg/assets/logo/logo.svg" alt="One Captcha Logo"> Powered by One Captcha</div><div id="slider-captcha-actions"><a href="https://docs.xyehr.cn/"><img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23888888'%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z'/%3E%3C/svg%3E" alt="About"></a><a><img id="retry-button" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23888888'%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z'/%3E%3C/svg%3E" alt="Refresh"></a></div></div></div>
