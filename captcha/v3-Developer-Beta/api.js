...
<div id="captcha-container">
    <div id="verify-section">
        ...
        <label for="verify-checkbox" id="captcha-label">我不是机器人。</label>
        <span id="success-message" style="display: none; font-weight: bold;">验证成功</span>
    </div>
    <div id="brand">
        ...
        <div class="privacy-terms-links">
            <a href="https://www.xyehr.cn/air-captcha-privacy-policy" id="privacy-link">隐私</a><p>·</p><a href="https://help.xyehr.cn/jekyll/2024-07-05-air-captcha.html" id="docs-link">文档</a>
        </div>
    </div>
</div>
...
<div id="slider-captcha">
    <div id="puzzle-container">
        <img id="puzzle-image" src="" alt="图片">
...
// 导出初始化函数
window.initAirCaptcha = initAirCaptcha;

</script>
`;

// 将HTML和CSS添加到页面中的id为air-captcha的div
document.getElementById('air-captcha').innerHTML = captchaStyles + captchaHTML + captchaScript;
