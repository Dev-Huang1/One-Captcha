(function() {
    ...
    function initCaptcha(container) {
        container.innerHTML = createCaptchaHTML();
        ...
        function applyTranslations(language) {
            ...
            container.querySelector('#submit-button').textContent = translations[language].submitButton;
        }
        ...
        function showSuccessMessage() {
            ...
            container.querySelector('#success-message').textContent = translations[detectLanguage()].successMessage;
            container.querySelector('#success-message').style.display = 'inline-block';
        }
